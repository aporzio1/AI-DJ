...
**Last updated:** 2026-04-20 (Kokoro download indicator in MiniPlayerBar — Split: Phase 1 icon+indeterminate spinner shared via singleton; % progress deferred pending upstream API)
